...
if($n!=0)
echo '</div> <br> <div style="margin : 50px;margin-left: 80px;"> <a href="b3.php"> <input class="btn btn-danger mb-3" type="submit" value="see your comment"></a> </div>';
// echo '</div> <br> <div style="margin : 50px;margin-left: 80px;"> <a href="b3.php"> <input class="btn btn-primary mb-3" type="submit" value="New Post"></a> </div>';
}else{
         echo ' <html>
        <body>
            <script>
...
<div>
 <div style="margin-left: 77px;"> <a href="b3.php"> <input class="btn btn-primary mb-3" type="submit" value="New Post"></a> </div>
